...
class SocialLoginAdminSettings extends ConfigFormBase
{
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        \Drupal::messenger()->addStatus(t('Settings saved successfully'), 'social_login');
...
function ajax_api_connection_autodetect($form, FormStateInterface $form_state)
{
    ...
    {
        \Drupal::messenger()->addError(t('Sorry, but the autodetection failed. Please try to open port 80/443 for outbound requests and install PHP cURL/fsockopen.'), 'social_login');
    }
...
function ajax_check_api_connection_settings($form, FormStateInterface $form_state)
{
    ...
    {
        \Drupal::messenger()->addStatus($success_message, 'social_login');
    }
    else
    {
        \Drupal::messenger()->addError($error_message, 'social_login');
    }
